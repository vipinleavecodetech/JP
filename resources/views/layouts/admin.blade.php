...
#admin_dash h4{
  ...
  #load{
    ...
    position:fixed;
    z-index:9999;
    background:url("https://headsup.leavecodetech.com/uploads/loader.gif") no-repeat center center #fff;
}
#loader {
  position: fixed;
  top: 50%;
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show" oncontextmenu="return false">
    
     @if(!strstr(url()->current(), 'invoice-mail'))
        <div id="load"></div>
    @endif
    <header class="app-header navbar" style="padding: 0.5rem 0rem;background: #000;">
        <button class="navbar-toggler sidebar-toggler d-lg-none mr-auto" type="button" data-toggle="sidebar-show">
            <span class="navbar-toggler-icon"></span>
        </button>
            <span class="navbar-brand-full"> 
              <a href="#" class="logo-my"><span><img src="{{ url('public/quiz-assets/images/logo.svg') }}" alt="" height="28"></span></a>
            </span>
