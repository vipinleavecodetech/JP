...
<style>
   ...
   ul.radio-boxs.cust_assad45 li .custhead45 h3.fs-subtitle {
       margin-bottom: 0px;
   }
   span.top-btns {
    margin-top: 6px;
                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="page-title-box">
                           ...
                           <h4 class="page-title">Start your free trial</h4>
                        </div>
                     </div>
                  </div>
                  <!-- end page title --> 
                        ...
                        <div class="card-box">
                           <form id="msform" action="{{ route('submitForm') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <?php
                                $rand_no="pat".rand();
                            ?>
                              <input type="hidden" value="<?=$rand_no?>" name="hidden_session_value" id="sess_val">
                              <fieldset>
                                 <h2 class="fs-title mb-4">What's your first name?</h2>
                                  <input type="text" name="fname" id="fname" maxlength="35" />
                               ...
                               <fieldset>
                                 <h2 class="fs-title mb-4">What's your Last name?</h2>
                                       <input type="text" name="lname" id="lname" maxlength="35"/>
                              ...
                              <fieldset>
                                 <h2 class="fs-title mb-4">What's your Email Address</h2>
                                       <input type="email" name="email" id="email" maxlength="35"/>
                              ...
                              <fieldset>
                                 ...
                                 <ul class="radio-boxs">
                                    <li>
                                       <input type="radio" id="m-gender" value="M" name="gender">
                                       <label for="m-gender">Male</label>
                                       <div class="check">
                                       </div>
                                    </li>
                                    <li>
                                       <input type="radio" id="f-gender" value="F" name="gender">
                            ...
                            <fieldset>
                              ...
                              <fieldset>
                                 <h2 class="fs-title">What medication do you prefer?</h2>Authentic generic version of Viagra made by Pfizer.Just as effective but for less. Active ingredient is Sildenafil.
                                
                                 <ul class="radio-boxs cust_assad45">
                                 <?php $medications = DB::table('manage_preference')->get();
                                 $i = 96;
                                 ...
                                 ?>
                                    <li>
                                       <div class="custhead45">
                                           <span class="top-btns">${{ $data->price }} per tablet</span>
                                          <h3 class="fs-subtitle">{{ $data->description }}</h3>

                                          <div class="cust_clas546">
                                            <input type="radio" id="{{$letter}}-option35" value="{{ $data->medication_name }}" name="selector35">
                                            <label for="{{$letter}}-option35">{{ $data->medication_name }} 
                                           <span class="top-btns-two">${{ $data->as_low_as_price }} per tablet</span></label>@if($data->popularity)<span class="pop_50">{{ $data->popularity }}</span>@endif
                                            <div class="check"></div>
                                          </div>
                                       </div>
                                       <img src="{{ $data->image }}">
                                 ...
                                 <?php } ?>
                                  {{-- <li>
                                    <div class="custhead45">
                                           <span class="top-btns">$3 per tablet</span>
                                       <h3 class="fs-subtitle">Cialis daily generic is taken once a day at a lower dosage than regular Cialis generic.</h3>
                                       <div class="cust_clas546">
                                          <input type="radio" id="b-option35" value="Generic Cialis Daily" name="selector35">
                                          <label for="b-option35">Generic Cialis Daily <span class="top-btns-two">$1.80 per tablet</span></label>
                                          <div class="check"></div>
                                       </div>
                                     </div>
                                       <img src="{{ url('public/quiz-assets/images/viagra2.png') }}">
                                     
                                    </li>
                                    <li>
                                        <div class="custhead45">
                                           <span class="top-btns">$10 per tablet</span>
                                          <h3 class="fs-subtitle">Authentic generic version of Cialis, just as effective but for less.</h3>
                                          <div class="cust_clas546">
                                             <input type="radio" id="c-option35" value="Generic Cialis" name="selector35">
                                             <label for="c-option35">Generic Cialis <span class="top-btns-two">$6 per tablet</span></label>
                                             <div class="check"></div>
                                          </div>
                                       </div>
                                       <img src="{{ url('public/quiz-assets/images/viagra3.png') }}">
                             
                                    </li>
                                 --}}
                                 </ul>
                                 <p class="step40_error"></p>
                                  <input type="button" name="previous" class="previous action-button" value="Previous" />
                                 <input type="button" name="next" class="step40 action-button" value="Next Step" />
                              </fieldset>


                              <fieldset>
                                 <h2 class="fs-title">Do you have a dosage preference? </h2>
                                 <h3 class="fs-subtitle" id="dosage_p_text">A starting dose of 50 mg is the most common for members who are new to the medication. Based on the information you provide, the doctor will determine if this dose (or another) is appropriate.</h3>
                                 <ul class="radio-boxs">
                                    <li>
                                       <input type="radio" id="a-option33" value="50mg" name="selector33">
                                       <label for="a-option33">50mg</label>
                                       <div class="check"></div>
                                    </li>
                                    <li>
                                       <input type="radio" id="b-option33" value="100mg" name="selector33">
                                       <label for="b-option33">100mg <span class="pop_50">Most Popular</span></label>
                                       <div class="check">
                                          <div class="inside"></div>
                                       </div>
                                    </li>
                                 </ul>
                                 <p class="step38_error"></p>
                                  <input type="button" name="previous" class="previous action-button" value="Previous" />
                                 <input type="button" name="next" class="step38 action-button" value="Next Step" />
                              </fieldset>


                              <fieldset>
                                 <h2 class="fs-title">How many times do you anticipate using the medication, if prescribed? </h2>
                                 
                                 <ul class="radio-boxs">
                                    <li>
                                       <input type="radio" id="a-option34" value="6 times per month" name="selector34">
                                       <label for="a-option34">6 times per month</label>
                                       <div class="check">
                                          <div class="inside"></div>
                                       </div>
                                    </li>
                                    <li>
                                       <input type="radio" id="b-option34" value="8 times per month." name="selector34">
                                       <label for="b-option34">8 times per month</label>
                                       <div class="check">
                                          <div class="inside"></div>
                                       </div>
                                    </li>
                                    <li>
                                       <input type="radio" id="c-option34" value="10 times per month" name="selector34">
                                       <label for="c-option34">10 times per month <span class="pop_50">Most Popular</span></label>
                                       <div class="check">
                                          <div class="inside"></div>
                                       </div>
                                    </li>
                                    <li>
                                       <input type="radio" id="d-option34" value="12 times per month." name="selector34">
                                       <label for="d-option34">12 times per month</label>
                                       <div class="check">
                                          <div class="inside"></div>
                                       </div>
                                    </li>
                                    <li>
                                       <input type="radio" id="e-option34" value="14 times per month." name="selector34">
                                       <label for="e-option34">14 times per month</label>
                                       <div class="check">
                                          <div class="inside"></div>
                                       </div>
                                    </li>
                                 </ul>
                                 <p class="step39_error"></p>
                                  <input type="button" name="previous" class="previous action-button" value="Previous" />
                                 <input type="button" name="next" class="step39 action-button" value="Next Step" />
                              </fieldset>
                              ...
                              <fieldset>
                                 ...
                                 <input type="button" name="previous" class="previous action-button" value="Previous" />
                                 <a href ="javascript:void(0);" name="submit_demo" class="demo_btn btn btn-success"  />Next Step</a>
                                 <input type="submit" name="submit" class="next action-button btnn_or" value="Next Step" />
                              </fieldset>
